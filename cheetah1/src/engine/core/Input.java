...
public class Input {
    ...
    /**
     * Returns the key that leaves.
     * @param keyCode Code of the key.
     * @return Leave the key pressed.
     */
    ...
    /**
     * Return the mouse button that is pressed.
    ...
    /**
     * Returns the mouse button that is held.
     * @param mouseButton Mouse button.
     * @return Press the button.
     */
    ...
    /**
     * Returns the mouse button that leaves.
     * @param mouseButton Mouse button.
     * @return Leave the button pressed.
     */
    ...
    /**
     * Checks if the mouse is in window or out of it.
     * @param enabled if it is in or out.
     */
