...
public class OBJModel {
	...
	/**
	 * Constructor for a OBJ model mesh. 
	 * @param fileName of the OBJ mesh.
	 */
	...
	/**
	 * Returns the result of the index of the model.
...
//			result.GetTexCoords().Get(i).SetY(1.0f - result.GetTexCoords().Get(i).GetY());
	...
	/**
	 * Parses the index of the OBJ model.
	 * @param token of index.
	 * @return result.
	 */
