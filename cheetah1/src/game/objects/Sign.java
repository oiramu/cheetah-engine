 ...
 * @since 2019
 */
public class Sign extends GameComponent implements Collidable {
     ...
     */
    public Sign(Transform transform) {
        if (mesh == null) {
        	float sizeY = 1.0f;
            sizeX = (float) ((double) sizeY / (1.12835820896f * 4.0));
        ...
        material = new Material(new Texture("sign/SPDCD0"));
